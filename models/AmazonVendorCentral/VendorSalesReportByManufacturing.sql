                ...
                from
                    (
                        select
                            ...
                            orderedrevenue.value:amount::float as orderedrevenue,
                            orderedrevenue.value:currencycode::varchar as currencycode,
                            orderedunits,
                            shippedrevenue.value:amount::float as shippedrevenue,
                            shippedcogs.value:amount::float as shippedcogs,
                            {% else %}
                            orderedrevenue.amount as orderedrevenue,
                            orderedrevenue.currencycode as currencycode,
                            orderedunits,
