...
{% set result =set_table_name("RetailProcurementOrdersStatus_tbl_ptrn","RetailProcurementOrdersStatus_exclude_tbl_ptrn") %}
...
{% for i in result %}
    ...
    (
        ...
        from
            ...
            {{ multi_unnesting("sellingParty", "address") }} as sellingParty_address
            {{ multi_unnesting("sellingParty", "taxInfo") }} as sellingParty_taxInfo
            {{ multi_unnesting("shipToParty", "address") }} as shipToParty_address
            {{ multi_unnesting("shipToParty", "taxInfo") }} as shipToParty_taxInfo
            {{ multi_unnesting("itemstatus", "netcost") }} as itemstatus_netcost
            {{ multi_unnesting("itemstatus", "listprice") }} as itemstatus_listprice
            {{ multi_unnesting("itemstatus", "orderedquantity") }} as itemstatus_orderedquantity
            {{ multi_unnesting("itemstatus", "acknowledgementstatus") }} as itemstatus_acknowledgementstatus
            {{ multi_unnesting("itemstatus_orderedQuantity", "orderedQuantity") }} as itemstatus_orderedQuantity_orderedQuantity
            {{ multi_unnesting("itemstatus_orderedQuantity", "orderedQuantityDetails") }} as itemstatus_orderedQuantity_orderedQuantityDetails
            {{ multi_unnesting("itemstatus_orderedQuantity_orderedQuantityDetails", "orderedQuantity") }} as itemstatus_orderedQuantity_orderedQuantityDetails_orderedQuantity
            {{ multi_unnesting("itemstatus_orderedQuantity_orderedQuantityDetails", "cancelledQuantity") }} as itemstatus_orderedQuantity_orderedQuantityDetails_cancelledQuantity
            {{ multi_unnesting("itemstatus_acknowledgementstatus", "acknowledgementStatusDetails") }} as itemstatus_acknowledgementstatus_acknowledgementStatusDetails
            {{ multi_unnesting("itemstatus_acknowledgementstatus_acknowledgementStatusDetails", "acceptedQuantity") }} as itemstatus_acknowledgementstatus_acknowledgementStatusDetails_acceptedQuantity
            {{ multi_unnesting("itemstatus_acknowledgementstatus_acknowledgementStatusDetails", "rejectedQuantity") }} as itemstatus_acknowledgementstatus_acknowledgementStatusDetails_rejectedQuantity
            {{ multi_unnesting("itemstatus_acknowledgementstatus", "acceptedquantity") }} as itemstatus_acknowledgementstatus_acceptedquantity
